<?php
    $file = file_get_contents("template/template.phtml");
    $file_header = file_get_contents("template/header.html");
    $file_styles = file_get_contents("template/styles.html");
    $file_footer = file_get_contents("template/footer.html");
